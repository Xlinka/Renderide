//! Unity triplanar transparent PBS (`Shader "PBSTriplanarTransparent"`).
//!
...
fn sample_surface(
    ...
    if (kw(mat._ALBEDOTEX)) {
        col = col * sample_triplanar(_MainTex, _MainTex_sampler, proj, mat._MainTex_LodBias);
    }
    ...
    return SurfaceData(col.rgb, col.a, metallic, roughness, occlusion, normal, emission);
}
