...
///
/// **Host contract:** the engine only applies a new sample when `FrameStartData.performance` is
/// not null; in-game metrics continue to show the last published values until the next non-null
/// payload.
