...
@group(2) @binding(1) var farTex: texture_2d<f32>;
@group(2) @binding(2) var farTex_sampler: sampler;
@group(2) @binding(3) var nearTex: texture_2d<f32>;
@group(2) @binding(4) var nearTex_sampler: sampler;
@group(2) @binding(5) var normalMap: texture_2d<f32>;
@group(2) @binding(6) var normalMap_sampler: sampler;
@group(2) @binding(7) var maskTex: texture_2d<f32>;
@group(2) @binding(8) var maskTex_sampler: sampler;
// --- End material block ---
