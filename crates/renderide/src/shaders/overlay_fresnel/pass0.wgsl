...
struct GlobalParams_std140_0
{
    ...
    @align(8) _BehindFarColor_0 : vec4<f16>,
    @align(16) _BehindNearColor_0 : vec4<f16>,
    @align(8) _Exp_0 : f32,
};
...
fn frag( _S1 : pixelInput_0, @builtin(position) vertex_1 : vec4<f32>) -> pixelOutput_0
{
    ...
    _S2.normal_1 = _S3;
    var _S4 : pixelOutput_0 = pixelOutput_0( vec4<f16>(mix(vec4<f32>(globalParams_0._BehindNearColor_0), vec4<f32>(globalParams_0._BehindFarColor_0), vec4<f32>(pow(1.0f - abs(dot(_S3, normalize(UnityPerCamera_0._WorldSpaceCameraPos_0.xyz - _S2.position_1.xyz))), globalParams_0._Exp_0)))) );
    return _S4;
}
