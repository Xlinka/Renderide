...
struct MaterialUniform {
    ...
    _pad0: u32,
    _pad1: u32,
    behindFarColor: vec4<f32>,
    behindNearColor: vec4<f32>,
    frontFarColor: vec4<f32>,
    frontNearColor: vec4<f32>,
    srcBlend: f32,
    dstBlend: f32,
    zWrite: f32,
    cull: f32,
...
@group(2) @binding(1) var behindFarTex: texture_2d<f32>;
@group(2) @binding(2) var behindFarTex_sampler: sampler;
@group(2) @binding(3) var behindNearTex: texture_2d<f32>;
@group(2) @binding(4) var behindNearTex_sampler: sampler;
@group(2) @binding(5) var frontFarTex: texture_2d<f32>;
@group(2) @binding(6) var frontFarTex_sampler: sampler;
@group(2) @binding(7) var frontNearTex: texture_2d<f32>;
@group(2) @binding(8) var frontNearTex_sampler: sampler;
@group(2) @binding(9) var normalMap: texture_2d<f32>;
@group(2) @binding(10) var normalMap_sampler: sampler;
// --- End material block ---
...
struct GlobalParams_std140_0
{
    ...
    @align(8) _FrontFarColor_0 : vec4<f16>,
    @align(16) _FrontNearColor_0 : vec4<f16>,
    @align(8) _Exp_0 : f32,
};
...
fn frag( _S1 : pixelInput_0, @builtin(position) vertex_1 : vec4<f32>) -> pixelOutput_0
{
    ...
    _S2.normal_1 = _S3;
    var _S4 : pixelOutput_0 = pixelOutput_0( vec4<f16>(mix(vec4<f32>(globalParams_0._FrontNearColor_0), vec4<f32>(globalParams_0._FrontFarColor_0), vec4<f32>(pow(pow(1.0f - abs(dot(_S3, normalize(UnityPerCamera_0._WorldSpaceCameraPos_0.xyz - _S2.position_1.xyz))), globalParams_0._Exp_0), globalParams_0._GammaCurve_0)))) );
    return _S4;
}
