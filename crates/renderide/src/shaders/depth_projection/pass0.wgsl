...
@group(1) @binding(4) var depthTex_sampler: sampler;
// --- End material block ---

// Generated by UnityShaderConverter — merged vertex + fragment stages.
enable f16;

@binding(27) @group(0) var _DepthTex_0 : texture_2d<f32>;

@binding(28) @group(0) var sampler_DepthTex_0 : sampler;
...
fn sampleDepth_0( uv_0 : vec2<f32>) -> f32
{
    ...
    return 1.0f - (textureSampleLevel((_DepthTex_0), (sampler_DepthTex_0), (vec4<f32>(_S1 * globalParams_0._DepthTex_ST_0.xy + globalParams_0._DepthTex_ST_0.zw, 0.0f, 0.0f).xy), (vec4<f32>(_S1 * globalParams_0._DepthTex_ST_0.xy + globalParams_0._DepthTex_ST_0.zw, 0.0f, 0.0f).w))).x;
}
...
{
    var _S2 : vec4<f16> = vec4<f16>((textureSample((_MainTex_0), (sampler_MainTex_0), (_S1.uv_0.xy * globalParams_0._MainTex_ST_0.xy + globalParams_0._MainTex_ST_0.zw))));
    var _S3 : bool;
