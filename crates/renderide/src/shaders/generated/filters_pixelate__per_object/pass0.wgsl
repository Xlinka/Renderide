...
{
    var _S2 : pixelOutput_0 = pixelOutput_0( vec4<f16>((textureSample((_GrabTexture_0), (unity_usc_resonite_macro_sampler_0), (round(_S1.grabPos_0.xy / vec2<f32>(_S1.grabPos_0.w) * globalParams_0._Resolution_0) / globalParams_0._Resolution_0)))) );
    return _S2;
}
