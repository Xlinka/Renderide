...
struct GlobalParams_std140_0
{
    ...
    @align(16) _RatioR_0 : f32,
    @align(4) _RatioG_0 : f32,
    @align(8) _RatioB_0 : f32,
    @align(4) _Lerp_0 : f32,
};
...
@id(0) override USC_GRADIENT_0 : bool = false;
...
fn frag( _S1 : pixelInput_0, @builtin(position) pos_0 : vec4<f32>) -> pixelOutput_0
{
    ...
    var _S3 : vec3<f16> = vec3<f16>(mix(vec3<f32>(_S2.xyz), vec3<f32>(vec3<f16>(f16(f32(_S2.x) * globalParams_0._RatioR_0 + f32(_S2.y) * globalParams_0._RatioG_0 + f32(_S2.z) * globalParams_0._RatioB_0))), vec3<f32>(globalParams_0._Lerp_0)));
    c_0.x = _S3.x;
    c_0.y = _S3.y;
    c_0.z = _S3.z;
    var _S4 : pixelOutput_0 = pixelOutput_0( c_0 );
    return _S4;
}
