...
@id(0) override USC_LERPTEX_POLARUV_0 : bool = false;

@id(1) override USC_LERPTEX_0 : bool = false;

@id(2) override USC_MULTI_VALUES_0 : bool = false;

@id(3) override USC_NORMALMAP_0 : bool = false;

@id(4) override USC_TEXTURE_0 : bool = false;
