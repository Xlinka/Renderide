...
//! Unity shader: `Volume/Unlit`
//! Source: `third_party/Resonite.UnityShaders/Assets/Shaders/Volume/VolumeUnlit.shader`
...
pub struct Material {
    pub volume: TextureHandle, // Volume
    pub stepSize: f32, // Step Size
    pub gain: f32, // Gain
    pub exp: f32, // Exponent
    pub lowClip: f32, // Low Clip
    pub highClip: f32, // High Clip
    pub accumulationCutoff: f32, // Accumulation Cutoff
    pub hitThreshold: f32, // Display Threshold
}
...
impl Default for Material {
    fn default() -> Self {
        Self {
            volume: 0,
            stepSize: 0.100000001,
            gain: 0.100000001,
            exp: 1.0,
            lowClip: 0.0,
            highClip: 1.0,
            accumulationCutoff: 100.0,
            hitThreshold: 0.5,
        }
    }
}
...
pub struct MaterialUniform {
    ...
    pub lowClip: f32,
    pub highClip: f32,
    pub accumulationCutoff: f32,
    pub hitThreshold: f32,
    pub _pad0: u32,
}
...
/// Primitive assembly for pass 0 (from ShaderLab `Cull`). Tags: `DisableBatching` = `True`; `IgnoreProjector` = `True`; `Queue` = `Transparent`; `RenderType` = `Transparent`.
