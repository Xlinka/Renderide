...
struct GlobalParams_std140_0
{
    ...
    @align(16) U_Scale_0 : vec3<f32>,
    @align(16) _Offset_0 : vec3<f32>,
};
...
struct vertexInput_0
{
    ...
    @location(7) uv0_0 : vec4<f32>,
    @location(1) uv1_0 : vec4<f32>,
    @location(2) uv2_0 : vec4<f32>,
    @location(3) uv3_0 : vec4<f32>,
};
...
@id(2) override USC_COLOR_0 : bool = false;

@id(3) override USC_COLOR_ALPHA_0 : bool = false;

@id(4) override USC_NORMAL_0 : bool = false;

@id(5) override USC_TANGENT_0 : bool = false;

@id(6) override USC_TANGENT4_0 : bool = false;

@id(7) override USC_UV0_0 : bool = false;
