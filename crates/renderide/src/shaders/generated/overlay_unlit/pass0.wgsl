...
struct GlobalParams_std140_0
{
    ...
    @align(8) _BehindColor_0 : vec4<f16>,
};
...
@id(1) override USC_MUL_ALPHA_INTENSITY_0 : bool = false;

@id(2) override USC_MUL_RGB_BY_ALPHA_0 : bool = false;

@id(3) override USC_POLARUV_0 : bool = false;

@id(4) override USC_TEXTURE_0 : bool = false;

@id(5) override USC_VERTEXCOLORS_0 : bool = false;

@id(6) override USC_VERTEX_HDRSRGB_COLOR_0 : bool = false;

@id(7) override USC_VERTEX_LINEAR_COLOR_0 : bool = false;
...
{
    var _S2 : pixelOutput_0 = pixelOutput_0( globalParams_0._BehindColor_0 );
    return _S2;
}
