...
@id(0) override USC_POISSON_DISC_0 : bool = false;

@id(1) override USC_RECTCLIP_0 : bool = false;

@id(2) override USC_REFRACT_0 : bool = false;

@id(3) override USC_REFRACT_NORMALMAP_0 : bool = false;

@id(4) override USC_SPREAD_TEX_0 : bool = false;
...
fn evrCalculateBlur_0( screenUv_1 : vec2<f32>,  uv_0 : vec2<f32>,  depth_0 : f32,  iterations_0 : f32) -> vec4<f16>
{
    ...
    for(;;)
    {
        ...
        var c_1 : vec4<f16> = c_0 + vec4<f16>((textureSample((_BackgroundTexture_0), (unity_usc_resonite_macro_sampler_0), (screenUv_1 + vec2<f32>(- cos(angle_0), sin(angle_0)) * spread_0))));
        n_0 = n_0 + i32(1);
        c_0 = c_1;
    }
