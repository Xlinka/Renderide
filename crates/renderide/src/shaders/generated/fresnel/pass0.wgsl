...
fn frag( _S1 : pixelInput_0, @builtin(position) vertex_1 : vec4<f32>) -> pixelOutput_0
{
    ...
    _S2.normal_1 = _S3;
    var _S4 : vec4<f16> = vec4<f16>(mix(vec4<f32>(globalParams_0._NearColor_0), vec4<f32>(globalParams_0._FarColor_0), vec4<f32>(pow(pow(1.0f - abs(dot(_S3, normalize(UnityPerCamera_0._WorldSpaceCameraPos_0.xyz - _S2.position_1.xyz))), globalParams_0._Exp_0), globalParams_0._GammaCurve_0))));
    var col_0 : vec4<f16> = _S4;
    col_0[i32(3)] = f16(pow(f32(_S4.w), globalParams_0._GammaCurve_0));
    var _S5 : pixelOutput_0 = pixelOutput_0( col_0 );
    return _S5;
}
