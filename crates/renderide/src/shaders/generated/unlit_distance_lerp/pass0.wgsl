...
@binding(31) @group(0) var sampler_NearTex_0 : sampler;
...
@id(0) override USC_WORLD_SPACE_0 : bool = true;

@id(1) override USC_LOCAL_SPACE_0 : bool = false;

@id(2) override USC_ALPHATEST_0 : bool = false;

@id(3) override USC_VERTEXCOLORS_0 : bool = false;
