...
fn frag( _S1 : pixelInput_0, @builtin(position) pos_0 : vec4<f32>) -> pixelOutput_0
{
    ...
    var _S3 : vec3<f16> = _S2.xyz;
    var _S4 : vec3<f16> = vec3<f16>(mix(vec3<f32>(_S3), vec3<f32>(vec3<f16>(1.0h) - _S3), vec3<f32>(globalParams_0._Lerp_0)));
    c_0.x = _S4.x;
    c_0.y = _S4.y;
    c_0.z = _S4.z;
    var _S5 : pixelOutput_0 = pixelOutput_0( c_0 );
    return _S5;
}
