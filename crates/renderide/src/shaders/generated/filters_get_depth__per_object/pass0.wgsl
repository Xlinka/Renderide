...
struct GlobalParams_std140_0
{
    ...
    @align(16) _Multiply_0 : f32,
    @align(4) _Offset_0 : f32,
};
...
struct v2f_0
{
    ...
    @location(1) projPos_0 : vec4<f32>,
    @builtin(position) pos_6 : vec4<f32>,
};
...
fn vert( _S4 : vertexInput_0) -> v2f_0
{
    ...
    o_1.projPos_0 = ComputeScreenPos_0(_S5);
    o_1.projPos_0[i32(2)] = - UnityObjectToViewPos_1(_S4.vertex_0).z;
    return o_1;
}

@id(0) override USC_CLIP_0 : bool = false;
...
{
    var _S2 : pixelOutput_0 = pixelOutput_0( vec4<f16>(vec3<f16>(vec3<f32>(saturate(LinearEyeDepth_0((textureSample((_CameraDepthTexture_0), (unity_usc_resonite_macro_sampler_0), (_S1.projPos_0.xy / vec2<f32>(_S1.projPos_0.w)))).x) * globalParams_0._Multiply_0 + globalParams_0._Offset_0))), 1.0h) );
    return _S2;
}
