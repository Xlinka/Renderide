...
//! Unity shader: `CubemapProjection`
//! Source: `third_party/Resonite.UnityShaders/Assets/Shaders/CubemapProjection.shader`
...
pub struct Material {
    pub cube: TextureHandle, // Cubemap
}
...
pub fn specialization_constants_f64(variant: &VariantKey) -> std::vec::Vec<(&'static str, f64)> {
    ...
    v.push(("0", if variant.flip { 1.0 } else { 0.0 }));
    v
}
