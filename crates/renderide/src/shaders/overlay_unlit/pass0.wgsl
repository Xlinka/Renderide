...
@group(2) @binding(1) var behindTex: texture_2d<f32>;
@group(2) @binding(2) var behindTex_sampler: sampler;
@group(2) @binding(3) var frontTex: texture_2d<f32>;
@group(2) @binding(4) var frontTex_sampler: sampler;
// --- End material block ---
