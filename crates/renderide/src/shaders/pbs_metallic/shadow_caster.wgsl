...
@group(2) @binding(3) var metallicGlossMap: texture_2d<f32>;
@group(2) @binding(4) var metallicGlossMap_sampler: sampler;
@group(2) @binding(5) var bumpMap: texture_2d<f32>;
@group(2) @binding(6) var bumpMap_sampler: sampler;
@group(2) @binding(7) var parallaxMap: texture_2d<f32>;
@group(2) @binding(8) var parallaxMap_sampler: sampler;
@group(2) @binding(9) var occlusionMap: texture_2d<f32>;
@group(2) @binding(10) var occlusionMap_sampler: sampler;
@group(2) @binding(11) var emissionMap: texture_2d<f32>;
@group(2) @binding(12) var emissionMap_sampler: sampler;
@group(2) @binding(13) var detailMask: texture_2d<f32>;
@group(2) @binding(14) var detailMask_sampler: sampler;
@group(2) @binding(15) var detailAlbedoMap: texture_2d<f32>;
@group(2) @binding(16) var detailAlbedoMap_sampler: sampler;
@group(2) @binding(17) var detailNormalMap: texture_2d<f32>;
@group(2) @binding(18) var detailNormalMap_sampler: sampler;
// --- End material block ---
