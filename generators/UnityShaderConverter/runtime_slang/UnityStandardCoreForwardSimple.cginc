...
//
// Renderide: Shadows UnityBuiltinCGIncludes/UnityStandardCoreForwardSimple.cginc (see runtime_slang/UnityStandardCore.cginc header).
// Intentional change: VertexGIForward expects float3 world position (Slang).
